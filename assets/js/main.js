...
(function () {
  ...
  var I18N = {
    el: {
      ...
      tst_title: "Τι λένε όσοι μας έχουν εμπιστευτεί",
      tst_score: "5,0",
      tst_count: "[NN] κριτικές",
      tst_more: "Δες όλες τις κριτικές στο Google",
      tst_1: "[Πραγματική κριτική Google, προς αντικατάσταση. Αντιγράψτε εδώ αυτούσιο το κείμενο μιας κριτικής.]",
      tst_1_by: "Όνομα Γ. · Google",
      tst_2: "[Πραγματική κριτική Google, προς αντικατάσταση. Αντιγράψτε εδώ αυτούσιο το κείμενο μιας κριτικής.]",
      tst_2_by: "Όνομα Μ. · Google",

      ct_title: "Επικοινωνία",
      ct_sub: "Στείλε μας μήνυμα και απαντάμε την ίδια μέρα.",
      ...
      form_lang: "Γλώσσα ενδιαφέροντος", form_age: "Ηλικία / τάξη μαθητή",
    ...
    en: {
      ...
      tst_title: "What those who trust us say",
      tst_score: "5.0",
      tst_count: "[NN] reviews",
      tst_more: "See all reviews on Google",
      tst_1: "[Real Google review, to be replaced. Paste the exact text of a review here.]",
      tst_1_by: "Name G. · Google",
      tst_2: "[Real Google review, to be replaced. Paste the exact text of a review here.]",
      tst_2_by: "Name M. · Google",

      ct_title: "Contact",
      ct_sub: "Send us a message and we reply the same day.",
      ct_addr_label: "ADDRESS", ct_phone_label: "PHONE", ct_social_label: "SOCIAL",
      form_name: "Full name *", form_phone: "Phone *", form_email: "Email",
      form_lang: "Language of interest", form_age: "Student age / grade",
    ...
    es: {
      ...
      tst_title: "Lo que dicen quienes confían en nosotros",
      tst_score: "5,0",
      tst_count: "[NN] reseñas",
      tst_more: "Ver todas las reseñas en Google",
      tst_1: "[Reseña real de Google, por sustituir. Pega aquí el texto exacto de una reseña.]",
      tst_1_by: "Nombre G. · Google",
      tst_2: "[Reseña real de Google, por sustituir. Pega aquí el texto exacto de una reseña.]",
      tst_2_by: "Nombre M. · Google",

      ct_title: "Contacto",
      ct_sub: "Escríbenos y te respondemos el mismo día.",
      ...
      form_lang: "Idioma de interés", form_age: "Edad / curso del alumno",
    ...
    fr: {
      ...
      tst_title: "Ce que disent celles et ceux qui nous font confiance",
      tst_score: "5,0",
      tst_count: "[NN] avis",
      tst_more: "Voir tous les avis sur Google",
      tst_1: "[Avis Google réel, à remplacer. Copiez ici le texte exact d’un avis.]",
      tst_1_by: "Nom G. · Google",
      tst_2: "[Avis Google réel, à remplacer. Copiez ici le texte exact d’un avis.]",
      tst_2_by: "Nom M. · Google",

      ct_title: "Contact",
      ct_sub: "Écris-nous, nous répondons le jour même.",
      ...
      form_lang: "Langue souhaitée", form_age: "Âge / classe de l’élève",
